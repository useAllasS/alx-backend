...
```bash
user@ubuntu:~$  wc -l Popular_Baby_Names.csv 
19419 Popular_Baby_Names.csv
user@ubuntu:~$  
user@ubuntu:~$ head Popular_Baby_Names.csv
...
- [x] `page_size`: the length of the returned dataset page
- [x] `page`: the current page number
- [x] `data`: the dataset page (equivalent to return from previous task)
- [x] `next_page`: number of the next page, None if no next page
- [x] `prev_page`: number of the previous page, None if no previous page
- [x] `total_pages`: the total number of pages in the dataset as an integer
